...
python.exe  "%HOMEDRIVE%%HOMEPATH%\devel\slt-observatoryMonitoring\Client\telescopeStatusTargetScheduler.py"
REM python.exe  "%HOMEDRIVE%%HOMEPATH%\devel\slt-observatoryMonitoring\Client\telescopeStatusSessionMetadata.py"